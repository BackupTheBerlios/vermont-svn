...
/*
 * calculates crc32 of given buffer
 * taken from FreeBSD kernel: COPYRIGHT (C) 1986 Gary S. Brown. Public domain. 
 * slightly modified to serve our purposes in Vermont
 * @param seed initial crc hash value
