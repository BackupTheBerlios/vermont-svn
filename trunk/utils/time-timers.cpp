/*
 this has been taken from IBM developer works
 you may use it to measure the overhead of one gettimeofday() call
 which may become a bottleneck in a high-timed application

 there is a partially caching gettimeofday() LD_PRELOAD hack somewhere
 (IBM? SUN?) available, but I can't find it
 */
